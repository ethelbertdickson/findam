...
const cards = [
  ...
  {
    title: "Browse posted needs",
    note: "See what people are looking for and find opportunities to help.",
    icon: "search-outline" as const,
    action: () => router.push("/requests"),
  },
  {
    title: "Post what you need",
    note: "Tell agents and providers what you are looking for and let the right match find you.",
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <Text style={styles.intro}>
          Find the people and opportunities behind the things you need.
        </Text>
        {cards.map((card) => (
          <Pressable key={card.title} style={styles.card} onPress={card.action}>
...
const styles = StyleSheet.create({
  ...
  intro: { color: COLORS.muted, fontSize: 15, lineHeight: 22, marginBottom: 4 },
  card: {
    flexDirection: "row",
    alignItems: "center",
    gap: 16,
  ...
  cardNote: { color: COLORS.muted, lineHeight: 19 },
  link: { color: COLORS.primary, fontWeight: "800", marginTop: 3 },
});
