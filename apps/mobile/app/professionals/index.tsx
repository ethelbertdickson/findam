  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <TextInput
        ...
        value={q}
        onChangeText={setQ}
        placeholder="Search plumbers, architects..."
      ...
      <ScrollView contentContainerStyle={styles.list}>
        {isLoading && <Text style={styles.note}>Loading professionals...</Text>}
        {isError && (
          <Text style={styles.note}>
            Professionals are temporarily unavailable.
          </Text>
        )}
        {!isLoading && !isError && data.length === 0 && (
          <Text style={styles.note}>No professionals found yet.</Text>
        )}
        {data.map((profile) => {
...
const styles = StyleSheet.create({
  ...
  bio: { color: COLORS.muted, lineHeight: 19 },
  ...
  note: { color: COLORS.muted, textAlign: "center", padding: 24 },
});
