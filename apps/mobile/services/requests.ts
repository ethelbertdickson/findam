...
export interface UserRequest { id: string; type: UserRequestType; title: string; description: string; status: string; createdAt?: string; contactPhone?: string | null; contactEmail?: string | null; contactMode?: string; createdBy?: { firstName?: string; lastName?: string; email?: string | null; phone?: string | null } | null; criteria?: Record<string, unknown> | null; city?: { name: string } | null; serviceCategory?: ProfessionalCategory | null; }
